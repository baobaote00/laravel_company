                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        @if ($item->company_status && isset($status['list'][$item->company_status]))
                            <i class="fa fa-circle" style="color:{!! $status['color'][$item->company_status] !!}"
                                title='{!! $status['list'][$item->company_status] !!}'></i>
                        @else
                    ...
                    <td>
                        ...
                        @if (Route::has('comments.by_context'))
                            <a href="{!! URL::route('comments.by_context', ['id' => $item->id, 'context' => 'company', '_token' => csrf_token()]) !!}">
                                <i class="fa fa-commenting" aria-hidden="true"></i>
                            </a>&nbsp;
                        @endif

                        <!--edit-->
                        <a href="{!! URL::route('company.edit', ['id' => $item->id, '_token' => csrf_token()]) !!}">
                            <i class="fa fa-edit f-tb-icon"></i>
                        </a>&nbsp;


                        <!--copy-->
                        <a href="{!! URL::route('company.copy', ['cid' => $item->id, '_token' => csrf_token()]) !!}" class="margin-left-5">
